...
PrototypeMaze.Level2 = {
  ...
  create: function() {
    ...
    this.map = this.game.add.tilemap('L2Map', 64, 64);
    ...
    this.map.setCollisionBetween(36, 53);

    //  Un-comment this on to see the collision tiles
    // this.layer.debug = true;

    //static objects
    this.skeleton = this.game.add.image(1800, 225, 'skeleton');
    this.skeleton2 = this.game.add.image(2380, 2400, 'skeleton');
    this.coins = this.game.add.sprite(1890, 210, 'coins');
    this.coins.anchor.setTo(0.5, 0.5);
    this.coins.collected = false;
    this.coins2 = this.game.add.sprite(2400, 2400, 'coins');
    this.coins2.anchor.setTo(0.5, 0.5);
    this.coins2.collected = false;
    this.gems = this.game.add.sprite(2010, 215, 'gems');
    this.gems.anchor.setTo(0.5, 0.5);
    this.gems.collected = false;
    this.gems2 = this.game.add.sprite(2340, 2350, 'gems');
    this.gems2.anchor.setTo(0.5, 0.5);
    this.gems2.collected = false;
    this.bones = this.game.add.image(100, 365, 'bones6');
    this.bones2 = this.game.add.image(2090, 2700, 'bones2');
    this.bones3 = this.game.add.image(1000, 170, 'bones5');
    this.roots1 = this.game.add.image(300, 200, 'roots2');
    this.roots4 = this.game.add.image(950, 150, 'roots');
    this.stalactice1 = this.game.add.image(1300, 2200, 'Stalactite3');
    this.stalactice2 = this.game.add.image(220, 1850, 'Stalactite_broken');
    this.stalactice3 = this.game.add.image(235, 1860, 'Stalactite_small4');
    this.stalactice4 = this.game.add.image(1525, 1500, 'Stalactite2');
    this.stalactice5 = this.game.add.image(1540, 1580, 'Stalactite4');
    this.stalactice6 = this.game.add.image(1105, 2505, 'Stalactite_small');
    this.stalactice7 = this.game.add.image(385, 2800, 'Stalactite_small_broken2');
    this.stalactice8 = this.game.add.image(1490, 2750, 'Stalactite');
    this.stalactice9 = this.game.add.image(1965, 2730, 'Stalactite_small_broken');
    this.stalactice10 = this.game.add.image(2200, 2200, 'Stalactite_small4');
    this.stalactice11 = this.game.add.image(1600, 1900, 'Stalactite_small3');
    this.stalactice12 = this.game.add.image(2100, 2200, 'Stalactite_broken2');
    ...
    this.levelDoor = this.game.add.sprite(2401, 3008, 'door2');
    ...
    this.torches.add(new torch(this.game, 90, 100));
    this.torches.add(new torch(this.game, 215, 100));
    this.torches.add(new torch(this.game, 1130, 1180));
    this.torches.add(new torch(this.game, 1450, 2330));
    this.torches.add(new torch(this.game, 2280, 2525));
...
setUpStrikerGroup: function()
{
    ...
    this.strikerAmount = 41;
    this.strikerGroupXTopBounds = 1300;  //group 1
    this.strikerGroupXBotBounds = 1175;
    this.strikerGroupYTopBounds = 1150;
    this.strikerGroupYBotBounds = 500;
    this.strikerGroup2XTopBounds = 1600;  //group 2
    this.strikerGroup2XBotBounds = 1450;
    this.strikerGroup2YTopBounds = 1300;
    this.strikerGroup2YBotBounds = 800;
    this.strikerGroup3XTopBounds = 2400;  //group 3
    this.strikerGroup3XBotBounds = 2050;
    this.strikerGroup3YTopBounds = 500;
    this.strikerGroup3YBotBounds = 150;
    this.strikerGroup4XTopBounds = 2450;  //group 4
    this.strikerGroup4XBotBounds = 1800;
    this.strikerGroup4YTopBounds = 1600;
    this.strikerGroup4YBotBounds = 1450;
    this.strikerGroup5XTopBounds = 2450;  //group 5
    this.strikerGroup5XBotBounds = 2325;
    this.strikerGroup5YTopBounds = 2300;
    this.strikerGroup5YBotBounds = 1900;
    this.strikerGroup6XTopBounds = 2200;  //group 6
    this.strikerGroup6XBotBounds = 2075;
    this.strikerGroup6YTopBounds = 2650;
    this.strikerGroup6YBotBounds = 2200;
    this.strikerGroup7XTopBounds = 1000;  //group 7
    this.strikerGroup7XBotBounds = 850;
    this.strikerGroup7YTopBounds = 2350;
    this.strikerGroup7YBotBounds = 2200;
    this.strikerGroup8XTopBounds = 700;  //group 8
    this.strikerGroup8XBotBounds = 450;
    this.strikerGroup8YTopBounds = 2350;
    this.strikerGroup8YBotBounds = 2200;
    this.strikerGroup9XTopBounds = 250;  //group 9
    this.strikerGroup9XBotBounds = 100;
    this.strikerGroup9YTopBounds = 2300;
    this.strikerGroup9YBotBounds = 2150;
    this.strikerGroup10XTopBounds = 350;  //group 10
    this.strikerGroup10XBotBounds = 150;
    this.strikerGroup10YTopBounds = 2800;
    this.strikerGroup10YBotBounds = 2525;
...
setUpRatGroup: function()
{
    ...
    this.ratAmount = 17;
    this.ratGroupXTopBounds = 800;  //first group
    this.ratGroupXBotBounds = 100;
    this.ratGroupYTopBounds = 450;
    this.ratGroupYBotBounds = 150;
    this.ratGroup2XTopBounds = 1600;  //second group
    this.ratGroup2XBotBounds = 950;
    this.ratGroup2YTopBounds = 1650;
    this.ratGroup2YBotBounds = 1250;
    this.ratGroup3XTopBounds = 1900;  //third group
    this.ratGroup3XBotBounds = 1250;
    this.ratGroup3YTopBounds = 2500;
    this.ratGroup3YBotBounds = 2400;
...
setUpCrabGroup: function()
{
    ...
    this.crabGroupXBotBounds = 100;
    this.crabGroupYTopBounds = 950;
    this.crabGroupYBotBounds = 700;
    this.crabGroup2XTopBounds = 1600;  //group 2
    this.crabGroup2XBotBounds = 950;
    this.crabGroup2YTopBounds = 1650;
    this.crabGroup2YBotBounds = 1250;
