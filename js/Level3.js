...
PrototypeMaze.Level3 = {
  ...
  create: function() {
    ...
    this.map = this.game.add.tilemap('L3Map', 64, 64);
    ...
    this.map.setCollisionBetween(72, 89);

    //  Un-comment this on to see the collision tiles
    // this.layer.debug = true;

    //static objects
    this.skeleton = this.game.add.image(2120, 1055, 'skeleton');
    this.coins = this.game.add.sprite(2200, 1025, 'coins');
    this.coins.anchor.setTo(0.5, 0.5);
    this.coins.collected = false;
    this.coins2 = this.game.add.sprite(1117, 2229, 'coins');
    this.coins2.anchor.setTo(0.5, 0.5);
    this.coins2.collected = false;
    this.coins3 = this.game.add.sprite(617, 1217, 'coins');
    this.coins3.anchor.setTo(0.5, 0.5);
    this.coins3.collected = false;
    this.gems = this.game.add.sprite(2075, 1065, 'gems');
    this.gems.anchor.setTo(0.5, 0.5);
    this.gems.collected = false;
    this.gems2 = this.game.add.sprite(875, 130, 'gems');
    ...
    this.bones3 = this.game.add.image(875, 420, 'bones5');
    this.bones4 = this.game.add.image(500, 2460, 'bones1');
    this.bones5 = this.game.add.image(770, 2500, 'bones4');
    this.bones6 = this.game.add.image(425, 2025, 'bones5');
    this.bones7 = this.game.add.image(800, 2230, 'bones3');
    this.bones8 = this.game.add.image(1100, 2220, 'bones2');
    this.bones9 = this.game.add.image(400, 600, 'bones4');
    this.bones10 = this.game.add.image(1630, 825, 'bones6');
    this.bones11 = this.game.add.image(1575, 1120, 'bones3');
    this.bones12 = this.game.add.image(1780, 1255, 'bones5');
    this.bones13 = this.game.add.image(2055, 2030, 'bones6');
    this.bones14 = this.game.add.image(2200, 2200, 'bones4');
    this.bones15 = this.game.add.image(1865, 2180, 'bones2');
    ...
    this.shroom2 = this.game.add.image(530, 395, 'mushroom_small_group');
    this.stalactice1 = this.game.add.image(1580, 2160, 'Stalactite3');
    ...
    this.stalactice4 = this.game.add.image(1030, 1950, 'Stalactite2');
    this.stalactice5 = this.game.add.image(1300, 1660, 'Stalactite4');
    this.stalactice6 = this.game.add.image(1155, 2400, 'Stalactite_small');
    this.stalactice7 = this.game.add.image(385, 2800, 'Stalactite_small_broken2');
    this.stalactice8 = this.game.add.image(1490, 2700, 'Stalactite');
    this.stalactice9 = this.game.add.image(1965, 2730, 'Stalactite_small_broken');
    this.stalactice10 = this.game.add.image(2200, 2660, 'Stalactite_small4');
    this.stalactice11 = this.game.add.image(1725, 2075, 'Stalactite_small3');
    ...
    this.mushroomes.add(new mushroom(this.game, 340, 415));
    this.mushroom1 = this.game.add.image(330, 400, 'mushroom_tall2');
    this.mushroomes.add(new mushroom(this.game, 605, 1150));
    this.mushroom2 = this.game.add.image(570, 1120, 'mushroom_group2');
    this.mushroomes.add(new mushroom(this.game, 1765, 270));
    this.mushroom3 = this.game.add.image(1780, 250, 'mushroom_tall2');
    this.mushroomes.add(new mushroom(this.game, 2100, 1880));
    this.mushroom4 = this.game.add.image(2050, 1870, 'mushroom_group2');
    this.mushroomes.add(new mushroom(this.game, 1635, 2260));
    this.mushroom5 = this.game.add.image(1620, 2280, 'mushroom_group2');
    this.mushroomes.add(new mushroom(this.game, 1580, 1440));
    this.mushroom6 = this.game.add.image(1640, 1370, 'mushroom_tall2');
    ...
    this.levelDoor = this.game.add.sprite(2401, 3008, 'door3');
...
setUpStrikerGroup: function()
{
    ...
    this.strikerAmount = 99;
    this.strikerGroupXTopBounds = 800;  //group 1
    this.strikerGroupXBotBounds = 450;
    this.strikerGroupYTopBounds = 200;
    this.strikerGroupYBotBounds = 150;
    this.strikerGroup2XTopBounds = 1100;  //group 2
    this.strikerGroup2XBotBounds = 1000;
    this.strikerGroup2YTopBounds = 875;
    this.strikerGroup2YBotBounds = 150;
    this.strikerGroup3XTopBounds = 1600;  //group 3
    this.strikerGroup3XBotBounds = 1250;
    this.strikerGroup3YTopBounds = 200;
    this.strikerGroup3YBotBounds = 150;
    this.strikerGroup4XTopBounds = 2425;  //group 4
    this.strikerGroup4XBotBounds = 1800;
    this.strikerGroup4YTopBounds = 200;
    this.strikerGroup4YBotBounds = 150;
    this.strikerGroup5XTopBounds = 600;  //group 5
    this.strikerGroup5XBotBounds = 300;
    this.strikerGroup5YTopBounds = 1225;
    this.strikerGroup5YBotBounds = 1175;
    this.strikerGroup6XTopBounds = 225;  //group 6
    this.strikerGroup6XBotBounds = 100;
    this.strikerGroup6YTopBounds = 1600;
    this.strikerGroup6YBotBounds = 1450;
    this.strikerGroup7XTopBounds = 600;  //group 7
    this.strikerGroup7XBotBounds = 350;
    this.strikerGroup7YTopBounds = 1700;
    this.strikerGroup7YBotBounds = 1475;
    this.strikerGroup8XTopBounds = 1025;  //group 8
    this.strikerGroup8XBotBounds = 100;
    this.strikerGroup8YTopBounds = 2800;
    this.strikerGroup8YBotBounds = 2700;
    this.strikerGroup9XTopBounds = 1525;  //group 9
    this.strikerGroup9XBotBounds = 1050;
    this.strikerGroup9YTopBounds = 2800;
    this.strikerGroup9YBotBounds = 2450;
    this.strikerGroup10XTopBounds = 1625;  //group 10
    this.strikerGroup10XBotBounds = 1250;
    this.strikerGroup10YTopBounds = 2225;
    this.strikerGroup10YBotBounds = 1950;
    this.strikerGroup11XTopBounds = 2000;  //group 11
    this.strikerGroup11XBotBounds = 1800;
    this.strikerGroup11YTopBounds = 2800;
    this.strikerGroup11YBotBounds = 2600;
    this.strikerGroup12XTopBounds = 2450;  //group 12
    this.strikerGroup12XBotBounds = 2325;
    this.strikerGroup12YTopBounds = 2650;
    this.strikerGroup12YBotBounds = 1575;
    ...
    for (var i = 0; i < this.strikerAmount; i++)
    {
        ...
        {
        striker.reset(this.game.rnd.integerInRange(this.strikerGroup12XBotBounds + 15, this.strikerGroup12XTopBounds - 15),
                      this.game.rnd.integerInRange(this.strikerGroup12YBotBounds + 15, this.strikerGroup12YTopBounds - 15));
        }
    }
},
...
setUpReaperGroup: function()
{
    ...
    this.reaperAmount = 10;
    this.reaperBunnyGroupX = 459;  //group 1
    this.reaperBunnyGroupY = 725;
    this.reaperGroupX = 575;
    this.reaperGroupY = 450;
    this.reaperBunnyGroup2X = 1525;  //group 2
    this.reaperBunnyGroup2Y = 1400;
    this.reaperGroup2X = 1525;
    this.reaperGroup2Y = 850;
    this.reaperBunnyGroup3X = 2100;  //group 3
    this.reaperBunnyGroup3Y = 400;
    this.reaperGroup3X = 2150;
    this.reaperGroup3Y = 1000;
    this.reaperBunnyGroup4X = 400;  //group 4
    this.reaperBunnyGroup4Y = 2225;
    this.reaperGroup4X = 1100;
    this.reaperGroup4Y = 2250;
    this.reaperBunnyGroup5X = 1300;  //group 5
    this.reaperBunnyGroup5Y = 2500;
    this.reaperGroup5X = 400;
    this.reaperGroup5Y = 2500;
    this.reaperBunnyGroup6X = 2000;  //group 6
    this.reaperBunnyGroup6Y = 1575;
    this.reaperGroup6X = 1575;
    this.reaperGroup6Y = 1650;
    // this.reaperBunnyGroup7X = 2000;  //group 7
    // this.reaperBunnyGroup7Y = 1675;
    // this.reaperGroup7X = 1500;
    // this.reaperGroup7Y = 1725;
    // this.reaperBunnyGroup8X = 2000;  //group 8
    // this.reaperBunnyGroup8Y = 2150;
    // this.reaperGroup8X = 2025;
    // this.reaperGroup8Y = 1900;
    this.reaperBunnyGroup9X = 2000;  //group 9
    this.reaperBunnyGroup9Y = 2250;
    this.reaperGroup9X = 2175;
    this.reaperGroup9Y = 1900;
    // this.reaperBunnyGroup10X = 2150;  //group 10
    // this.reaperBunnyGroup10Y = 2300;
    // this.reaperGroup10X = 1750;
    // this.reaperGroup10Y = 2800;
    ...
    for (var i = 0; i < this.reaperAmount; i++)
    {
        ...
        {
          reaper.reset(this.reaperGroup5X, this.reaperGroup5Y);
        }else if (i == 5)
        {
          reaper.reset(this.reaperGroup6X, this.reaperGroup6Y);
        // }else if (i == 6)
        // {
        //   reaper.reset(this.reaperGroup7X, this.reaperGroup7Y);
        // }else if (i == 7)
        // {
        //   reaper.reset(this.reaperGroup8X, this.reaperGroup8Y);
        }else if (i == 8)
        {
          reaper.reset(this.reaperGroup9X, this.reaperGroup9Y);
        }
        // }else if (i == 9)
        // {
        //   reaper.reset(this.reaperGroup10X, this.reaperGroup10Y);
        // }
    }
    ...
    for (var i = 0; i < this.reaperAmount; i++)
    {
      ...
      if (i == 0)
      {
        reaperBunny.reset(this.reaperBunnyGroupX, this.reaperBunnyGroupY);
      }else if (i == 1)
      {
        reaperBunny.reset(this.reaperBunnyGroup2X, this.reaperBunnyGroup2Y);
      }else if (i == 2)
      {
        reaperBunny.reset(this.reaperBunnyGroup3X, this.reaperBunnyGroup3Y);
      }else if (i == 3)
      {
        reaperBunny.reset(this.reaperBunnyGroup4X, this.reaperBunnyGroup4Y);
      }else if (i == 4)
      {
        reaperBunny.reset(this.reaperBunnyGroup5X, this.reaperBunnyGroup5Y);
      }else if (i == 5)
      {
        reaperBunny.reset(this.reaperBunnyGroup6X, this.reaperBunnyGroup6Y);
      // }else if (i == 6)
      // {
      //   reaperBunny.reset(this.reaperBunnyGroup7X, this.reaperBunnyGroup7Y);
      // }else if (i == 7)
      // {
      //   reaperBunny.reset(this.reaperBunnyGroup8X, this.reaperBunnyGroup8Y);
      }else if (i == 8)
      {
        reaperBunny.reset(this.reaperBunnyGroup9X, this.reaperBunnyGroup9Y);
      }
      // }else if (i == 9)
      // {
      //   reaperBunny.reset(this.reaperBunnyGroup10X, this.reaperBunnyGroup10Y);
      // }
    }
},
...
setUpWanderer: function()
{
    ...
    //***Setup wanderer Body***
    this.wanderer = this.game.add.sprite(800, 1700, 'strikerMovement');
