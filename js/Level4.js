...
PrototypeMaze.Level4 = {
  ...
  create: function() {
    ...
    this.map = this.game.add.tilemap('L4Map', 64, 64);
    ...
    this.map.setCollisionBetween(108, 125);
    ...
    this.coins = this.game.add.sprite(2340, 2225, 'coins');
    this.coins.anchor.setTo(0.5, 0.5);
    this.coins.collected = false;
    this.coins2 = this.game.add.sprite(917, 2829, 'coins');
    this.coins2.anchor.setTo(0.5, 0.5);
    this.coins2.collected = false;
    this.coins3 = this.game.add.sprite(1149, 1025, 'coins');
    this.coins3.anchor.setTo(0.5, 0.5);
    this.coins3.collected = false;
    this.gems = this.game.add.sprite(2375, 2165, 'gems');
    this.gems.anchor.setTo(0.5, 0.5);
    this.gems.collected = false;
    this.gems2 = this.game.add.sprite(70, 1200, 'gems');
    ...
    this.stalactice4 = this.game.add.image(930, 1750, 'Stalactite2');
    this.stalactice5 = this.game.add.image(1300, 1460, 'Stalactite4');
    ...
    this.stalactice9 = this.game.add.image(1865, 2680, 'Stalactite_small_broken');
    ...
    this.mushroomes.add(new mushroom(this.game, 1170, 1050));
    this.mushroom1 = this.game.add.image(1150, 1030, 'mushroom_tall2');
    this.mushroomes.add(new mushroom(this.game, 1625, 1760));
    this.mushroom2 = this.game.add.image(1600, 1740, 'mushroom_group2');
    ...
    this.levelDoor = this.game.add.sprite(2465, 3008, 'door4');
    this.mainChar = this.game.add.sprite(100, 160, 'player');
    this.sideChar = this.game.add.sprite(100, 130, 'companion');
...
setUpStrikerGroup: function()
{
    ...
    this.strikerAmount = 72;
    this.strikerGroupXTopBounds = 1000;  //group 1
    this.strikerGroupXBotBounds = 700;
    this.strikerGroupYTopBounds = 200;
    this.strikerGroupYBotBounds = 150;
    this.strikerGroup2XTopBounds = 1350;  //group 2
    this.strikerGroup2XBotBounds = 1350;
    this.strikerGroup2YTopBounds = 250;
    this.strikerGroup2YBotBounds = 250;
    this.strikerGroup3XTopBounds = 1550;  //group 3
    this.strikerGroup3XBotBounds = 1550;
    this.strikerGroup3YTopBounds = 250;
    this.strikerGroup3YBotBounds = 250;
    this.strikerGroup4XTopBounds = 2075;  //group 4
    this.strikerGroup4XBotBounds = 2000;
    this.strikerGroup4YTopBounds = 950;
    this.strikerGroup4YBotBounds = 550;
    this.strikerGroup5XTopBounds = 1250;  //group 5
    this.strikerGroup5XBotBounds = 1125;
    this.strikerGroup5YTopBounds = 750;
    this.strikerGroup5YBotBounds = 550;
    this.strikerGroup6XTopBounds = 350;  //group 6
    this.strikerGroup6XBotBounds = 100;
    this.strikerGroup6YTopBounds = 750;
    this.strikerGroup6YBotBounds = 675;
    this.strikerGroup7XTopBounds = 550;  //group 7
    this.strikerGroup7XBotBounds = 475;
    this.strikerGroup7YTopBounds = 1250;
    this.strikerGroup7YBotBounds = 1000;
    this.strikerGroup8XTopBounds = 1625;  //group 8
    this.strikerGroup8XBotBounds = 1425;
    this.strikerGroup8YTopBounds = 1725;
    this.strikerGroup8YBotBounds = 1500;
    this.strikerGroup9XTopBounds = 1025;  //group 9
    this.strikerGroup9XBotBounds = 475;
    this.strikerGroup9YTopBounds = 1800;
    this.strikerGroup9YBotBounds = 1750;
    this.strikerGroup10XTopBounds = 1150;  //group 10
    this.strikerGroup10XBotBounds = 850;
    this.strikerGroup10YTopBounds = 2050;
    this.strikerGroup10YBotBounds = 2000;
    this.strikerGroup11XTopBounds = 1550;  //group 11
    this.strikerGroup11XBotBounds = 1250;
    this.strikerGroup11YTopBounds = 2250;
    this.strikerGroup11YBotBounds = 2200;
    this.strikerGroup12XTopBounds = 2475;  //group 12
    this.strikerGroup12XBotBounds = 2250;
    this.strikerGroup12YTopBounds = 2250;
    this.strikerGroup12YBotBounds = 2150;
    this.strikerGroup13XTopBounds = 1000;  //group 13
    this.strikerGroup13XBotBounds = 675;
    this.strikerGroup13YTopBounds = 2550;
    this.strikerGroup13YBotBounds = 2500;
    this.strikerGroup14XTopBounds = 1800;  //group 14
    this.strikerGroup14XBotBounds = 1450;
    this.strikerGroup14YTopBounds = 2825;
    this.strikerGroup14YBotBounds = 2750;
    this.strikerGroup15XTopBounds = 2400;  //group 15
    this.strikerGroup15XBotBounds = 2000;
    this.strikerGroup15YTopBounds = 2750;
    this.strikerGroup15YBotBounds = 2550;
    ...
    for (var i = 0; i < this.strikerAmount; i++)
    {
        ...
        {
        striker.reset(this.game.rnd.integerInRange(this.strikerGroup13XBotBounds + 15, this.strikerGroup13XTopBounds - 15),
                      this.game.rnd.integerInRange(this.strikerGroup13YBotBounds + 15, this.strikerGroup13YTopBounds - 15));
        }else if (i < 67 && i >= 61)
        {
        striker.reset(this.game.rnd.integerInRange(this.strikerGroup14XBotBounds + 15, this.strikerGroup14XTopBounds - 15),
                      this.game.rnd.integerInRange(this.strikerGroup14YBotBounds + 15, this.strikerGroup14YTopBounds - 15));
        }else if (i < 72 && i >= 67)
        {
        striker.reset(this.game.rnd.integerInRange(this.strikerGroup15XBotBounds + 15, this.strikerGroup15XTopBounds - 15),
                      this.game.rnd.integerInRange(this.strikerGroup15YBotBounds + 15, this.strikerGroup15YTopBounds - 15));
        }
    }
},
...
setUpRatGroup: function()
{
    ...
    this.ratAmount = 19;
    this.ratGroupXTopBounds = 350;  //first group
    this.ratGroupXBotBounds = 100;
    this.ratGroupYTopBounds = 450;
    this.ratGroupYBotBounds = 300;
    this.ratGroup2XTopBounds = 2450;  //second group
    this.ratGroup2XBotBounds = 1700;
    this.ratGroup2YTopBounds = 200;
    this.ratGroup2YBotBounds = 150;
    this.ratGroup3XTopBounds = 1650;  //third group
    this.ratGroup3XBotBounds = 1350;
    this.ratGroup3YTopBounds = 950;
    this.ratGroup3YBotBounds = 700;
    this.ratGroup4XTopBounds = 500;  //fourth group
    this.ratGroup4XBotBounds = 150;
    this.ratGroup4YTopBounds = 2075;
    this.ratGroup4YBotBounds = 2000;
...
setUpReaperGroup: function()
{
    ...
    this.reaperAmount = 4;
    this.reaperBunnyGroupX = 1200;  //group 1
    this.reaperBunnyGroupY = 750;
    this.reaperGroupX = 1825;
    this.reaperGroupY = 750;
    this.reaperBunnyGroup2X = 2250;  //group 2
    this.reaperBunnyGroup2Y = 600;
    this.reaperGroup2X = 2450;
    this.reaperGroup2Y = 650;
    this.reaperBunnyGroup3X = 1225;  //group 3
    this.reaperBunnyGroup3Y = 2025;
    this.reaperGroup3X = 1225;
    this.reaperGroup3Y = 1550;
    this.reaperBunnyGroup4X = 2250;  //group 4
    this.reaperBunnyGroup4Y = 1300;
    this.reaperGroup4X = 2250;
    this.reaperGroup4Y = 1900;
...
setUpCrabGroup: function()
{
    ...
    this.crabAmount = 13;
    this.crabGroupXTopBounds = 1000;  //group 1
    this.crabGroupXBotBounds = 675;
    this.crabGroupYTopBounds = 1500;
    this.crabGroupYBotBounds = 1250;
    this.crabGroup2XTopBounds = 500;  //group 2
    this.crabGroup2XBotBounds = 150;
    this.crabGroup2YTopBounds = 2650;
    this.crabGroup2YBotBounds = 2300;
    this.crabGroup3XTopBounds = 2400;  //group 3
    this.crabGroup3XBotBounds = 2000;
    this.crabGroup3YTopBounds = 2750;
    this.crabGroup3YBotBounds = 2550;
...
setUpWanderer: function()
{
    ...
    //***Setup wanderer Body***
    this.wanderer = this.game.add.sprite(1700, 2500, 'strikerMovement');
        ...
        { //once animation is done play struggle
          ...
          if (this.deathTimer == 0)//player recieves enough damage to die
          {
            ...
            if (this.gameOverAnimationDelay == 0)
            {
              this.mice.stop();
              this.charDeath.play();
              this.game.state.start('GameOver', true, false, 4);
              this.walking.stop();
              this.music.stop();
              this.water.stop();
            }else
