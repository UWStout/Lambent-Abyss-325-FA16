...
//title screen
PrototypeMaze.Credits = function() {};

PrototypeMaze.Credits = {
  ...
  create: function() {
    ...
    this.videoTime = this.game.time.totalElapsedSeconds() + 45;
    ...
    this.video = this.game.add.video('creditsCS');

    this.video.play(false);

    this.video.addToWorld(this.game.width / 2, this.game.height / 2, 0.5, 0.5, 0.4, 0.6);

    this.goBackButton = this.game.add.sprite(670, 550, 'GoBack');
