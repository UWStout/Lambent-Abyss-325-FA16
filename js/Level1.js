...
PrototypeMaze.Level1 = {
  ...
  create: function() {
    ...
    this.map = this.game.add.tilemap('L1Map', 64, 64);
    ...
    //static objects
    this.skeleton = this.game.add.image(1990, 1100, 'skeleton');
    this.skeleton2 = this.game.add.image(2375, 155, 'skeleton');
    this.coins = this.game.add.sprite(1970, 1125, 'coins');
    this.coins.anchor.setTo(0.5, 0.5);
    this.coins.collected = false;
    this.coins2 = this.game.add.sprite(2400, 160, 'coins');
    this.coins2.anchor.setTo(0.5, 0.5);
    this.coins2.collected = false;
    this.gems = this.game.add.sprite(2010, 1075, 'gems');
    this.gems.anchor.setTo(0.5, 0.5);
    this.gems.collected = false;
    this.gems2 = this.game.add.sprite(2450, 150, 'gems');
    this.gems2.anchor.setTo(0.5, 0.5);
    this.gems2.collected = false;
    this.bones = this.game.add.image(100, 365, 'bones6');
    this.bones2 = this.game.add.image(2030, 2780, 'bones2');
    this.bones3 = this.game.add.image(1375, 360, 'bones5');
    this.roots1 = this.game.add.image(300, 200, 'roots2');
    this.roots4 = this.game.add.image(950, 150, 'roots');
    this.stalactice1 = this.game.add.image(1300, 1860, 'Stalactite3');
    this.stalactice2 = this.game.add.image(85, 1900, 'Stalactite_broken');
    this.stalactice3 = this.game.add.image(105, 1910, 'Stalactite_small4');
    this.stalactice4 = this.game.add.image(1500, 1750, 'Stalactite2');
    this.stalactice5 = this.game.add.image(1400, 1580, 'Stalactite4');
    this.stalactice6 = this.game.add.image(900, 2375, 'Stalactite_small');
    ...
    this.stalactice9 = this.game.add.image(1965, 2500, 'Stalactite_small_broken');
    this.stalactice10 = this.game.add.image(2200, 2760, 'Stalactite_small4');
    this.stalactice11 = this.game.add.image(1300, 2075, 'Stalactite_small3');
    ...
    this.torches.add(new torch(this.game, 1000, 540));
    this.torches.add(new torch(this.game, 2000, 1245));
    this.torches.add(new torch(this.game, 960, 2080));
    this.torches.add(new torch(this.game, 365, 2465));
    this.torches.add(new torch(this.game, 1710, 2650));
    this.torches.add(new torch(this.game, 845, 1185));
...
levelChange: function() {
  this.walking.stop();
  this.game.state.start('1CS');

},

collisionsDoor: function() {

    //collision dectection for mainchar and door to change level
...
setUpStrikerGroup: function()
{
    ...
    this.strikerAmount = 30;
    this.strikerGroupXTopBounds = 1800;  //group 1
    this.strikerGroupXBotBounds = 500;
    this.strikerGroupYTopBounds = 350;
    this.strikerGroupYBotBounds = 140;
    this.strikerGroup2XTopBounds = 2450;  //group 2
    this.strikerGroup2XBotBounds = 2260;
    this.strikerGroup2YTopBounds = 1800;
    this.strikerGroup2YBotBounds = 800;
    this.strikerGroup3XTopBounds = 900;  //group 3
    this.strikerGroup3XBotBounds = 730;
    this.strikerGroup3YTopBounds = 1800;
    this.strikerGroup3YBotBounds = 1230;
    this.strikerGroup4XTopBounds = 550;  //group 4
    this.strikerGroup4XBotBounds = 100;
    this.strikerGroup4YTopBounds = 2200;
    this.strikerGroup4YBotBounds = 1800;
    ...
    for (var i = 0; i < this.strikerAmount; i++)
    {
        ...
        striker.strikerRadians = 0;
        striker.strikerDegrees = 0;
...
setUpRatGroup: function()
{
    ...
    this.ratAmount = 15;
    this.ratGroupXTopBounds = 1100;  //first group
    this.ratGroupXBotBounds = 100;
    this.ratGroupYTopBounds = 1000;
    this.ratGroupYBotBounds = 850;
