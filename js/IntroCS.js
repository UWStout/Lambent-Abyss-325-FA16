...
//title screen
PrototypeMaze.IntroCS = function() {};

PrototypeMaze.IntroCS = {

  create: function() {

    this.videoTime = this.game.time.totalElapsedSeconds() + 26;
    ...
    this.video.addToWorld(this.game.width / 2, this.game.height / 2, 0.5, 0.5, 0.5, 0.6);
